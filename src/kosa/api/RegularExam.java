...
//		}
		...
		// 이메일 검증 sunggu507@naver.com
		// 숫자먼저 ㄴㄴ / 골뱅이 check / 뒤에 .com 두번 비매칭
//		if(str.matches("^[a-zA-Z][\\w]{2,10}[@][\\w]{2,10}[.][\\w]{2,3}")) {
//			System.out.println("매칭");
//		} else {
//			System.out.println("비매칭");
//		}
...
//		//이미지 구분하기 jpg png gif
//		// jpg png gif 대소문자 구분 안하고 됨
